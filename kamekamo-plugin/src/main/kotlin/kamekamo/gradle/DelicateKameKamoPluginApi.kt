...
/**
 * Marks declarations in the KameKamoPlugin API that are **delicate** &mdash; they have limited
...
public annotation class DelicateKameKamoPluginApi(val message: String = "See kdoc.")