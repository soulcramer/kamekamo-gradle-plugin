...
private fun Project.startParameterProperties(key: String): Provider<String> {
    val provider =
        project.rootProject.getOrCreateExtra("kamekamo.properties.provider.start-properties") {
...
internal fun Project.localProperty(key: String): Provider<String> {
    return localPropertiesProvider(key, "kamekamo.properties.provider.local-properties") {
...
internal fun Project.localGradleProperty(key: String): Provider<String> {
    return localPropertiesProvider(key, "kamekamo.properties.provider.local-gradle-properties") {
