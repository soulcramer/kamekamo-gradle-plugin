...
import kamekamo.gradle.tasks.BootstrapTask
import kamekamo.gradle.tasks.ProgressListener
import kamekamo.gradle.tasks.ProgressResponseBody
...
internal abstract class UpdateRobolectricJarsTask : DefaultTask(), BootstrapTask {
    ...
    @get:Internal
    abstract val sdkVersions: ListProperty<Int>

    @get:Internal
    abstract val instrumentedVersion: Property<Int>
    ...
    fun download() {
        ...
        for (version in versions) {
            ...
            if (destinationFile.exists()) {
                ...
                logger.debug("$TAG Downloading $jarName from Maven Central.")
                if (offline.get()) {
                ...
                downloadVersion(client, dependencyJar, destinationFile)
                System.out.flush()
            }
        }
                        ...
                        if (done) {
                            ...
                            if (firstUpdate) {
                                ...
                                if (contentLength == -1L) {
                                    ...
                                    progressBar =
                                        ProgressBarBuilder()
                                            .setTaskName(dependencyJar.version)
