package kamekamo.dependencyrake
...
// These are dependencies we manage directly in KameKamoExtension or other plugins
...
constructor(objects: ObjectFactory, providers: ProviderFactory) : AbstractPostProcessingTask() {
    ...
    val modes: SetProperty<AnalysisMode> =
        objects
            ...
            .convention(
                providers
                    .gradleProperty("kamekamo.dependencyrake.modes")
